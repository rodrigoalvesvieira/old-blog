...
This post about building a simple API only for fetching data, not persisting. And I'll not mention REST here.

The "Rabl (Rabl)":http://github.com/nesquena/rabl gem let's you easily make data available as JSON, using this gem is a real straightforward process. All you need to do is pass <span class="small_code">respond_to :json</span> on the controller of the resource you wanna set available as JSON.
...
* The <span class="small_code">collection</span> method takes the instance variable containing the objects you want to display, in my example, <span class="small_code">@city</span>
...
Rabl is very robust, if JSON is the problem, this gem solves it. Of course what I showed here is just a small part of what Rabl lets you do, I hope this blog post helps you out when you need to develop your own API. If you have something to add please leave it in the comments.
