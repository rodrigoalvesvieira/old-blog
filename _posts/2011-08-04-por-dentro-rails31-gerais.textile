---
layout: post
title: Por dentro do Rails 3.1: Mudanças Gerais
---
...
h3. Resolução de Dependências 'automática'
...
h3. SCSS gerado via gerador de scaffold

Quando você gera um scaffold o Rails 3.1 já cria automaticamente um arquivo SCSS com o nome do controller em <span class="small_code">app/assets/stylesheets</span>

Além disso o gerador já cria arquivos .coffee e .scss correspondentes, se você não quiser isso passe a opção <span class="small_code">--skip-assets</span> ao comando.

h3. jQuery é default

Depois de muito tempo de insistência da comunidade, o framework JavaScript finalmente é padrão.

h3. JSON no lugar de XML

Até o Rails 3.1 os controllers gerados criavam blocos de renderização de formatos HTML e XML, agora é HTML e JSON.

h3. Output mais bonito de testes unitários

Uma das dependências de desenvolvimento default dos apps no Rails 3.1 é a gem <a href="https://github.com/TwP/turn" title="Gem Turn">turn</a> que colore a saída dos seus testes.
...
* Agora é definitivo: Templates .rhtml que já não eram habituais desde o Rails 2.1 agora não são mais válidos.
...
Até o próximo post, onde eu vou abordar as novidades no ActiveRecord 3.1. <a href="http://twitter.com/#!/rodrigoalvieira" title="Siga-me no Twitter">Siga-me no Twitter</a> ou <a href="http://www.rodrigoalvesvieira.com/atom.xml" title="assine o feed do blog">assine o feed do blog</a> pra receber o post "fresquinho" :D
