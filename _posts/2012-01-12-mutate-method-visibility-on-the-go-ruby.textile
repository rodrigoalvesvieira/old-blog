...
In the <span class="small_code">ShamelessSon</span> class, we told Ruby to mark the <span class="small_code">bank_account</span> method as public, making it available to the class' (<span class="small_code">ShamelessSon</span>) instances to use, in this case, <span class="small_code">dillinger</span>.
