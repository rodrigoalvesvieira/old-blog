...
Rails 3.1 generates code with the new (1.9) "Ruby hash notation (Ruby 1.9 Hash notation)":http://peepcode.com/blog/2011/rip-ruby-hash-rocket-syntax, I think this is nice for "pushing" the community forward, encouraging the use of the language's new version.
...
h2. Automatic dependency resolution
...
h2. SCSS via scaffold generator
...
h2. XML is gone. Let's welcome JSON
...
h2. Prettier, more human, unit test output

The new Rails puts a gem by default in your _Gemfile_. It's "turn (turn Gem)":https://github.com/TwP/turn, which colorizes your tests' output in the console. Not as flexible as RSpec yet, as it doesn't currently support formatting options but very good anyway!
