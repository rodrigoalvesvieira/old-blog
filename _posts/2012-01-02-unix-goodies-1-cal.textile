...
<span class="drops">T</span>his is the first post of a series called Unix Goodies. In this series I will write a ton of blog posts, each one about a specific Unix program that may save your life. This one is about <span class="small_code">cal</span>, the tiny calendar program, that seems to be quite unpopular.
