...
Firstly, make a copy of your production.rb file and call it staging.rb, and of course it should be in <span class="small_code>Rails.root/config/environments/</span>.
