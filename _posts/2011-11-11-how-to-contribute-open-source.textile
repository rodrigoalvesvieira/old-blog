...
After making your changes and WRITING THE TESTS (I'm making sure you won't forget it), then add the tweaked and/or new files and <span class="small_code">git commit</span> 'em.
...
<pre class="terminal">  $ git push my_hpricot my_patch </span>
...
That's it, of course there may be a specific project that demands more procedures for accepting contributions but the one I explained here must be sufficient to most projects.
